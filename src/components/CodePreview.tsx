...
export const CodePreview = forwardRef<HTMLDivElement, CodePreviewProps>(
  function CodePreview({ code, filename, onDownload, isSigned }, ref) {
    ...
    return (
      <div ref={ref} className="animate-fade-in overflow-hidden rounded-xl border border-border bg-code">
